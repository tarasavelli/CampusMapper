...
public class Backend {
    ...
    public Path getRoute(String start, String end) {
        ...
        for (int i = 0; i < intersections.size(); i++) {
            Intersection cIntersection = intersections.get(i);
            if(cIntersection.getName().equalsIgnoreCase(start) && cIntersection.isValid == true) { // If intersection matches start string
                startVertex = cIntersection;
            }
            if(cIntersection.getName().equalsIgnoreCase(end)  && cIntersection.isValid == true) { // If intersection matches end string
