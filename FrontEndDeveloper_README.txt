...
Frontend.java: The frontend for the Campus Mapper project that provides a command line user interface that allows the user to use the various modes available to navigate around the UW Madison campus.
TestFrontend.java: Tests the functionality of the Frontend through Junit tests
 ...
 * Helped Organize Meetings and Debug
